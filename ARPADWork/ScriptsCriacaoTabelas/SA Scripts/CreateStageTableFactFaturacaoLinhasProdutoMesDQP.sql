IF NOT EXISTS (SELECT name FROM sys.tables where name = 'FactFaturacaoLinhasProdutoMesDQP')
BEGIN
	CREATE TABLE [dbo].FactFaturacaoLinhasProdutoMesDQP(
...
END
ELSE
	TRUNCATE TABLE FactFaturacaoLinhasProdutoMesDQP
